...
"""autogenerated by genpy from sound_play/SoundRequestActionFeedback.msg. Do not edit."""
import sys
...
class SoundRequestActionFeedback(genpy.Message):
  _md5sum = "4577e8c5420cc167578de330a5e37d82"
  _type = "sound_play/SoundRequestActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','sound_play/SoundRequestFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SoundRequestActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = sound_play.msg.SoundRequestFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = sound_play.msg.SoundRequestFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B2I().pack(_x.feedback.playing, _x.feedback.stamp.secs, _x.feedback.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.playing, _x.feedback.stamp.secs, _x.feedback.stamp.nsecs,) = _get_struct_B2I().unpack(str[start:end])
      self.feedback.playing = bool(self.feedback.playing)
      return self
